...
async function seedDB() {
  ...
  await seedProducts(briefcases_titles, briefcases_imgs, "Perfumes");
  await seedProducts(travel_titles, travel_imgs, "Shoes");
  await seedProducts(miniBags_titles, miniBags_imgs, "Women");
  await seedProducts(
  ...
  await seedProducts(totes_titles, totes_imgs, "Watches");
